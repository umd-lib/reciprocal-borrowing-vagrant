...
The Vagrant uses CentOS 7.2/Apache 2.4.6, as it is anticipated that this configuration will be used in production.
...
Configuration file for the Shibboleth SP daemon. Modified the "ApplicationDefaults" stanza to point to the IdP:
